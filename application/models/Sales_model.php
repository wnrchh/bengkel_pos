...
class Sales_model extends CI_Model {
	...
	var $column_order = array( 'a.return_bit','a.id','a.sales_date','a.sales_code','a.reference_no','a.grand_total','a.payment_status','a.created_by','b.customer_name','a.paid_amount','a.sales_status','a.pos','a.plat_nomor'); //set column field database for datatable orderable
	var $column_search = array('sales_due','a.return_bit','a.id','a.sales_date','a.sales_code','a.reference_no','a.grand_total','a.payment_status','a.created_by','b.customer_name','a.paid_amount','a.sales_status','a.pos','a.plat_nomor'); //set column field database for datatable searchable 
	...
	public function verify_save_and_update(){
	    ...
	    if($command=='save'){//Create sales code unique if first time entry
		    ...
		    $sales_entry = array(
		    				...
		    				'plat_nomor' 				=> get_field($customer_id , 'db_customers', 'plat_nomor' ),
