				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tbody style="border-bottom-style: dashed;border-width: 0.1px;">
						<?php
			              ...
			              $subtotal=0;
			              $tax_amt=0;
			              $q2=$this->db->query("select b.sales_price, a.discount_type,a.discount_input,a.discount_amt, b.item_name,a.sales_qty,a.unit_total_cost,a.price_per_unit,a.tax_amt,c.tax,a.total_cost ,a.description from db_salesitems a,db_items b,db_tax c where c.id=a.tax_id and b.id=a.item_id and a.sales_id='$sales_id'");
			              foreach ($q2->result() as $res2) {
			                  echo "<tr>";  
			                  echo "<td style='padding-left: 2px; padding-right: 2px;' valign='top'>".++$i."</td>";
			                  echo "<td style='padding-left: 2px; padding-right: 2px;'>".$res2->item_name."<br>catt:" .$res2->description."</td>";
					...
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;font-weight: bold;" colspan="5" align="right"><?= $this->lang->line('total_discount'); ?></td>
						<td style=" padding-left: 2px; padding-right: 2px;font-weight: bold;" align="right"><?= number_format($total_discount,2); ?></td>
					</tr>
					...
					<tr>
						...
						<td style=" padding-left: 2px; padding-right: 2px;" align="right"><?= number_format($previous_due,2,'.',''); ?></td>
					</tr>
