                  ...
                  <div class="col-md-12">
                     ...
                     <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                           <li class="active"><a href="#tab_1" data-toggle="tab"><?= $this->lang->line('sales_payments'); ?></a></li>
                           <li><a href="#tab_2" data-toggle="tab"><?= $this->lang->line('customer_payments'); ?></a></li>
                        </ul>
                           ...
                           <div class="tab-pane" id="tab_2">
                              <div class="row">
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <br><br>
                                    <div class="table-responsive">
                                       <table class="table table-bordered table-hover customer_payments" id="report-data-2" >
                                          <thead>
                                             <tr class="bg-blue">
                                                <th style="">#</th>
                                                <th style=""><?= $this->lang->line('payment_date'); ?></th>
          ...
          if(to_date == "")
             {
               ...
               $.post("show_sales_payments_report",{payment_type:payment_type,customer_id:customer_id,from_date:from_date,to_date:to_date},function(result){
                 //alert(result);
                   setTimeout(function() {
                    $(".sales_payments tbody").empty().append(result);     
                    $(".overlay").remove();
                   }, 0);
                  });
               $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
               $.post("customer_payments_report",{payment_type:payment_type,customer_id:customer_id,from_date:from_date,to_date:to_date},function(result){
                 //alert(result);
                   setTimeout(function() {
                    $(".customer_payments tbody").empty().append(result);     
                    $(".overlay").remove();
                   }, 0);
                  }); 
