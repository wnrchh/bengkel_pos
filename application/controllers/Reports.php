...
class Reports extends MY_Controller {
	...
	//Services report
	public function customers_services_report(){
		$this->permission_check('sales_report');
		$data=$this->data;
		$data['page_title']="Laporan Service";
		 $this->load->view('report-services', $data);
	}

	public function customer_performance_report(){
		$this->permission_check('customer_report');
		$data=$this->data;
		$data['page_title']="Laporan Customer ";
		 $this->load->view('report-customer-performance', $data);
	}

	public function product_performance_report(){
		$this->permission_check('product_report');
		$data=$this->data;
		$data['page_title']="Laporan Product ";
		 $this->load->view('report-product-performance', $data);
	}
}
